...
# --batch_size 128 --warm_epoch 0 --num_epochs 120 \
...
# --spm_activation gelu --tau_selective 0.8 --tau_comprehensive 1.5 --seed 1 \
...
# nohup sh train_eval_f30k.sh >> /I2T/DivE-main/runs/f30k_test1/sh260223_128_seed1.log >&1 &
