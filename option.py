...
parser.add_argument('--img_folder', default='runs/f30k_test1/pic/',help='Attention softmax temperature.')
parser.add_argument('--tensor_file', default='runs/f30k_test1/pic/sim.pkl',help='Attention softmax temperature.')
